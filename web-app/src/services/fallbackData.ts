...
export const FALLBACK_DEALS_CATALOG: ProductDeal[] = [
  // =========================================================================
  // 1. GERMANY & EUROPE DEALS (EUR €) — Frankfurt, Berlin, Munich
  // =========================================================================
  {
  ...
  // =========================================================================
  // 2. UNITED KINGDOM DEALS (GBP £) — London, Manchester
  // =========================================================================
  {
  ...
  {
    id: 'asda-deal-pg-tips-tea',
    product: {
      id: 'p-pg-tips-240-bags',
      name: 'PG Tips Original Black Tea Bags (Box of 240)',
      brand: 'PG Tips',
      category: 'Beverages',
      packageSize: 240,
      unit: 'pack',
    ...
    store: {
      id: 'asda-london-superstore',
      retailerId: 'asda-uk',
      name: 'Asda Superstore',
      branch: 'Old Kent Road, London',
      distanceKm: 3.2,
      address: 'Old Kent Rd, London SE1 5AG, United Kingdom',
      latitude: 51.4880,
      longitude: -0.0760
    },
    pricing: {
    ...
    offer: {
      ...
      verificationStatus: 'verified_retailer',
      sourceType: 'flyer',
      sourceUrl: 'https://groceries.asda.com',
      lastVerified: new Date().toISOString()
    },
    dealScore: 97.5
  },
  ...
  // =========================================================================
  // 3. PAKISTAN DEALS (PKR Rs.) — Lahore, Karachi, Islamabad
  // =========================================================================
  {
