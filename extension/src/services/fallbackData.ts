...
export const POPULAR_DAILY_ESSENTIALS = [
  'Cooking Oil 5L',
  'Basmati Rice 5kg',
  'Wheat Flour (Atta) 10kg',
  'Full Cream Milk 1L',
  'Farm Fresh Eggs 12',
...
export const FALLBACK_DEALS_CATALOG: ProductDeal[] = [
  ...
  {
    id: 'deal-milkpak-12x1l-mtr',
    product: {
      id: 'p-milkpak-12x1l',
      name: 'Nestle MilkPak UHT Milk 1L (Box of 12)',
      brand: 'Nestle',
      category: 'Dairy',
      packageSize: 12,
      unit: 'L',
  ...
  {
    id: 'deal-lipton-tea-900g-alf',
    product: {
      id: 'p-lipton-900g',
      name: 'Lipton Yellow Label Pure Black Tea 900g',
      brand: 'Lipton',
      category: 'Beverages',
      packageSize: 900,
      unit: 'g',
  ...
  {
    id: 'deal-rooh-afza-800ml-crf',
    product: {
      id: 'p-rooh-afza-800ml',
  ...
  // ==========================================
  // 5. SPICES & COOKING ESSENTIALS
  // ==========================================
  {
    id: 'deal-shan-biryani-masala-imz',
    product: {
      id: 'p-shan-biryani',
  ...
  {
    id: 'deal-national-salt-800g-alf',
    product: {
      id: 'p-national-salt-800g',
      name: 'National Iodized Table Salt 800g Polybag',
      brand: 'National',
      category: 'Grocery',
      packageSize: 800,
      unit: 'g',
  ...
  {
    id: 'deal-mitchells-ketchup-800g-crf',
    product: {
      id: 'p-mitchells-ketchup-800g',
      name: 'Mitchell\'s Tomato Ketchup Pouch 800g',
      brand: 'Mitchell\'s',
      category: 'Grocery',
      packageSize: 800,
      unit: 'g',
  ...
  {
    id: 'deal-chicken-boneless-1kg-crf',
    product: {
  ...
  {
    id: 'deal-harpic-1l-alf',
    product: {
      id: 'p-harpic-1l',
      name: 'Harpic Power Plus Toilet Cleaner 1000ml Bottle',
      brand: 'Generic',
      category: 'Household',
      packageSize: 1,
      unit: 'L',
  ...
  {
    id: 'deal-colgate-total-140g-crf',
    product: {
      id: 'p-colgate-140g',
